...
const todos = () => {
    ...
    const initElementWrapperCreate = () => {
        ...
        return elementlib.elementCreate(initElementWrapperData);
    }
    ...
    const initElementHeaderCreate = () => {
        ...
        return elementlib.elementCreate(initElementHeaderData);
    }
    ...
    const initElementContentsCreate = () => {
        ...
        return elementlib.elementCreate(initElementContentsData);
    }
    ...
    const createTodoElement = ({ id, todo, complete }) => {
        const createTodoElementData = {
            ...
            children: [
                ...
                {
                    tagName: "div",
                    events: [{ type: "dblclick", callback: handleContentDbclick }],
                ...
                {
                    tagName: "span",
                    events: [{ type: "click", callback: handleRemoveClick }],
                    attrs: { className: "todo-remove", textContent: "X" }
                }
            ]
        }

        return elementlib.elementCreate(createTodoElementData);
    }

    // TODO DATA
    const addTodo = (value) => {
        const todo = { id: utilitylib.uuid(), todo: value, complete: false };
    ...
    const completeTodoView = (id, isComplete) => {
        const completeTarget = utilitylib.getElement(id);
    ...
    const modifyTodoView = (id) => {
        const parentTarget = utilitylib.getElement(id);
    ...
    const removeTodoView = (id) => {
        const removeTarget = utilitylib.getElement(id);
